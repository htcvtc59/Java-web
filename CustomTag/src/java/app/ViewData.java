 ...
 * @author MacOS
 */
public class ViewData extends BodyTagSupport {
    ...
    public int doStartTag() throws JspException {
        ...
        JspWriter out = pageContext.getOut();
        ArrayList<Book> lstb = d.tableBook(db, table, countrow, namerow);
        for (Book book : lstb) {
            try {
                System.out.println();
                out.println("<h5>" + book.getId() + "---" + book.getTitle() + "---" + book.getDes() 
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in ViewData tag", ex);
    }
